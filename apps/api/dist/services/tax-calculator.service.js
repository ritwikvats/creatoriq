...
exports.taxCalculatorService = exports.TaxCalculatorService = void 0;
class TaxCalculatorService {
    constructor() {
        ...
        this.REBATE_LIMIT = 700000;
        this.REBATE_AMOUNT = 25000;
        // GST Threshold
        this.GST_THRESHOLD = 2000000; // ₹20L
    }
    /**
    ...
    calculateSurcharge(income, tax) {
        if (income > 5000000)
            return tax * 0.10; // 10% surcharge above ₹50L
        if (income > 10000000)
            return tax * 0.15; // 15% surcharge above ₹1Cr
        return 0;
    }
    /**
     * Calculate GST liability
     */
    calculateGST(income, hasRegistration = false) {
     ...
     */
    generateSuggestions(input, taxableIncome, deductions) {
        const suggestions = [];
...
exports.taxCalculatorService = new TaxCalculatorService();
