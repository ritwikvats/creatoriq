 ...
 */
router.get('/timeline', auth_middleware_1.requireAuth, async (req, res, next) => {
 ...
 */
router.get('/growth', auth_middleware_1.requireAuth, async (req, res, next) => {
    const userId = req.user.id;
 ...
 */
function calculateGrowthRates(snapshots, res) {
